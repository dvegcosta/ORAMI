...
/**
 * Design system central do Orami.
 * A identidade continua baseada no lilás/roxo existente no app, mas com
 * contraste, superfícies e estados mais consistentes nos dois temas.
 */
export const TOKENS = {
  spacing: {
    xs: 4,
...
const aplicarAcabamentoVisual = (nomeEstilo, estilo, cores) => {
  ...
  // Normalize the font family so legacy `REM` values receive the loaded face.
